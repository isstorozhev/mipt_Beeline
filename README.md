...
1) Архитектурная целостность: код хорошо соответствует первоначальным требованиям.
2) Масштабируемость: на данный момент легкий код, который может быть расширен или модифицирован.
3) Функциональность: код хорошо выполняет свои функции и удовлетворяет требования заказчика.
4) Производительность: быстрый и эффективный код
5) Ремонтопригодность: код легко можно обслужить, исправить ошибки
6) Кодовое качество: хорошо написанный код, он чистый, понятный.
